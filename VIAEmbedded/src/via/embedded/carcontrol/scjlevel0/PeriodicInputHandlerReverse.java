...
public class PeriodicInputHandlerReverse extends PeriodicEventHandler {
	...
	public PeriodicInputHandlerReverse(PriorityParameters priority, PeriodicParameters release, 
