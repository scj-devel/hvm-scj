...
public class PeriodicSpeedHandlerDrive extends PeriodicEventHandler {
	...
	public PeriodicSpeedHandlerDrive(PriorityParameters priority, PeriodicParameters release, 
