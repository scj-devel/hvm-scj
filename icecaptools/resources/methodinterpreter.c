...
static int32 methodInterpreter(unsigned short currentMethodNumber, int32* fp) {
    ...
    loop: while (1) {
        ...
        case IRETURN_OPCODE: {
            ...
            unsigned char lambdaAdjustment = pgm_read_word(&currentMethod->classIndex) & 0x1;
        ...
        callMethod: {
            ...
            unsigned char lambdaAdjustment = pgm_read_word(&methodInfo->classIndex) & 0x1;  /* adjustment for lambda methods, if this is a lambda method */
