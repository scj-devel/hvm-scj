...
public class StackManager {
	...
	public StackManager(StringBuffer output, NoDuplicatesMemorySegment localVariables, int maxLocals,
	...
	public StackManager copy() {
		StackManager clone = new StackManager(output, this.localVariables, localVariableManager.getMaxLocals(),
				isSynthetic, this.spManipulator);
