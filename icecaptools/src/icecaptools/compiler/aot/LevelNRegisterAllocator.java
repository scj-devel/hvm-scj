...
public class LevelNRegisterAllocator extends StackManager {
	...
	public LevelNRegisterAllocator(StringBuffer output, NoDuplicatesMemorySegment localVariables, int level,
			int maxLocals, boolean isSynthetic, SPManipulator spManipulator) {
	...
	public LevelNRegisterAllocator(NoDuplicatesMemorySegment localVariables, int level, int maxLocals,
			boolean isSynthetic, SPManipulator spManipulator) {
	...
	public StackManager copy() {
		LevelNRegisterAllocator clone = new LevelNRegisterAllocator(output, localVariables, this.stackCache.length,
				localVariableManager.getMaxLocals(), this.isSynthetic, this.spManipulator);
