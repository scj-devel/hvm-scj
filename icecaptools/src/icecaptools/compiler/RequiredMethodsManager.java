...
public class RequiredMethodsManager extends RequiredEntryManager {
	...
	public RequiredMethodsManager(IDGenerator idGen, boolean supportLoading) {
		...
		addRequiredMethod(idGen, "java.lang.ArithmeticException", "<init>", "()V",
		...
		addRequiredMethod(idGen, "java.lang.NullPointerException", "<init>", "()V",
		...
		addRequiredMethod(idGen, "java.lang.StringBuffer", "append", "(F)Ljava/lang/StringBuffer;",
				"java_lang_StringBuffer_append");
		addRequiredMethod(idGen, "java.lang.StringBuilder", "append", "(F)Ljava/lang/StringBuilder;",
	...
	public boolean isRequieredMethod(String clazz, String targetMethodName, String targetMethodSignature) {
		return entries.contains(clazz + targetMethodName + targetMethodSignature);
	}
}
