...
import carcontrol.scjlevel0.bt.Car;
...
/**
 * This CarLevel0_BT_AtSAME class uses the SCJ level 0 example in package carcontrol.scjlevel0.bt
 * to execute in SAME.
 * 
 * @author hso
 *
 */
public class CarLevel0_BT_AtSAME extends SCJTargetConfigurationSAME {  
	...
	public static void main(String[] args) {
		...
		init();
		devices.Console.println("CarLevel0_BT_AtSAME started");
		...
		delay (2000);
		blink (2000);
		devices.Console.println("CarLevel0_BT_AtSAME end");
	}
}
