...
import carcontrol.scjlevel0.motor.Car;
import test.same70.configuration.SCJTargetConfigurationSAME;
import vm.Machine;
import vm.MachineFactory;
import vm.Memory;

public class CarLevel0_Motor_AtSAME extends SCJTargetConfigurationSAME {  
	...
	public static void main(String[] args) {
		...
		init();
		devices.Console.println("CarLevel0_Motor_AtSAME started");
		...
		delay (2000);
		blink (2000);
		devices.Console.println("CarLevel0_Motor_AtSAME end");
	}
