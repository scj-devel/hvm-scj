...
public abstract class ATMega2560TargetConfiguration extends BaseTargetConfiguration implements TargetConfiguration {
	...
	public String[] getBuildCommands() {
		return new String[] {
				"avr-gcc -mmcu=atmega2560 -Wall -gdwarf-2 -Os -DJAVA_STACK_SIZE=192 -DF_CPU=10000000 -std=gnu99 -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums natives_avr.c",
