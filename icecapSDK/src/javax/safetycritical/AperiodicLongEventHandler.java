...
/**
 * This class encapsulates an aperiodic event handler that is passed 
 * a long value when it is released.
...
public abstract class AperiodicLongEventHandler extends ManagedLongEventHandler {
	...
	protected long aperiodicLongData = -1;
	
	/**
	 * Constructs an aperiodic long event handler that can be explicitly released.
	 * 
	 ...
	 */
	public AperiodicLongEventHandler(PriorityParameters priority, AperiodicParameters release,
	...
	protected AperiodicLongEventHandler(PriorityParameters priority, AperiodicParameters release,
	...
	/**
	 * Release this aperiodic long event handler
	 */
	@SCJAllowed
	public final void release(long data) {
		aperiodicLongData = data;
		ManagedEventHandler.handlerBehavior.aperiodicLongHandlerRelease(this);
	}
