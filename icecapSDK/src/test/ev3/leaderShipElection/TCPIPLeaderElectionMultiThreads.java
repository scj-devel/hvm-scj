...
public class TCPIPLeaderElectionMultiThreads {
	...
	private static class Receiver extends AperiodicEventHandler {
		...
		public Receiver(PriorityParameters priority, AperiodicParameters release, StorageParameters storage,
				Mission m, ReceiverExecutor executor, int id) {
	...
	private static class RobotActor extends PeriodicEventHandler {
		public RobotActor(PriorityParameters priority, PeriodicParameters release, StorageParameters storage, Mission m) {
			super(priority, release, storage);
		}
