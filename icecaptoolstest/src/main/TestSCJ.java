...
public class TestSCJ extends TestAll {
	...
	protected boolean includeFileInTest(String test) {
		return test.endsWith(".java") && test.startsWith("TestSCJSingle");  //  TestPrintStream TestSCJSingleRawMemory_IOPort1  TestSCJSingleRawMemory_MemoryMapped1  TestHardWareObjectForByte
	}
