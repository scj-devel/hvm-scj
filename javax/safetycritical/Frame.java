...
public final class Frame 
{
   ...
   /*@ 
     public normal_behavior
       requires this.getDuration()  != null && this.getHandlers()  != null;
       requires ( this.getDuration().getMilliseconds() > 0 ||
                  this.getDuration().getNanoseconds() > 0 );
       ...
       ensures this.getDuration().equals(\old(duration)) && this.getHandlers() == \old(handlers); 
     also
